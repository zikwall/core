...
encore.module('ui.modal', function (module, require, $) {
    ...
    Modal.component = 'encore-ui-modal';
     ...
     * @returns {encore.ui.modal_L18.Modal.prototype@call;getContent@call;find}
     */
     ...
     * @returns {encore.ui.modal_L18.Modal.prototype@pro;$modal@call;find}
     */
    ...
    var _setGlobalModalTargetHandler = function () {
        ...
        $("a[data-target='#globalModal']").off('.encore:globalModal');

        // deprecated use action handler instead @see get action
        $(document).off('click.encore:globalModal').on('click.encore:globalModal', "a[data-target='#globalModal']", function (evt) {
            evt.preventDefault();
