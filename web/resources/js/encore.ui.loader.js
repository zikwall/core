 ...
 * @param {type} param2
 */
encore.module('ui.loader', function (module, require, $) {

    var DEFAULT_LOADER_SELECTOR = '#encore-ui-loader-default';
    ...
    var init = function () {
        $(document).on('click.encore:modules:ui:loader', '[data-ui-loader]', function (evt) {
            return module.initLoaderButton(this, evt);
        });

        $(document).on('afterValidate.encore:modules:ui:loader', function (evt, messages, errors) {
            if (errors.length) {
