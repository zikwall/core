/**
 * Manages the client/server communication. Handles encore json api responses and
 * pjax requests.
 */
encore.module('ui.richtext', function(module, require, $) {
    ...
    Richtext.component = 'encore-ui-richtext';
