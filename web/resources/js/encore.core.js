...
var encore = encore || (function ($) {
     ...
     * 
     * - full namespace encore.modules.ui.modal
     * - or module.ui.modal
     * - or short ui.modal
     * 
     * Usage:
     * 
     * encore.module('ui.modal', function(module, require, $) {...});
     * 
    ...
    var module = function (id, moduleFunction) {
        ...
        instance.id = 'zikwall.encore.modules.' + _cutModulePrefix(id);
     ...
     * or classes.
     * 
     * For the module encore.modules.ui.modal you can search:
     * 
     * require('ui.modal');
     * require('modules.ui.modal');
     * require('encore.modules.ui.modal');
     * 
     * @param {type} moduleId
    ...
    var resolveNameSpace = function (typePath, init) {
        try {
            //cut encore.modules prefix if present
    ...
    var _setNameSpace = function (path, obj) {
        try {
            //cut enccore modules prefix if present
    ...
    /**
     * Cuts the prefix encore.modules or modules. from the given value.
     * @param {type} value
     * @returns {unresolved}
     */
    var _cutModulePrefix = function (value) {
        return _cutPrefix(_cutPrefix(value, 'zikwall.encore.'), 'modules.');
    };

    /**
     * Cuts a prefix from a string, this is already available in encore.util but
    ...
    event.on('encore:modules:client:pjax:success', function (evt) {
    ...
    }).on('encore:modules:client:pjax:beforeSend', function (evt) {
        unloaded = [];
        $.each(moduleArr, function (i, module) {
            if (module.unload) {
                module.unload();
