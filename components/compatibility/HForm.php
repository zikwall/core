...
namespace zikwall\encore\modules\core\components\compatibility;

use zikwall\encore\modules\core\widgets\MarkdownEditor;
use zikwall\encore\modules\core\widgets\MultiSelectField;
use Yii;
            ...
            if (isset($definition['type'])) {
                switch ($definition['type']) {
                    ...
                    case 'markdown':
                        ...
                        $returnField .= MarkdownEditor::widget(array('fieldId' => $name));
                        return $returnField;
                    default:
