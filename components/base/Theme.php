...
use zikwall\encore\modules\core\libs\ThemeHelper;
...
class Theme extends \yii\base\Theme
{
    ...
    public $themePath = '@zikwall/encore/themes/';
    ...
    {
        if ($this->getBasePath() == '') {
            $this->setBasePath('@zikwall/encore/themes/' . $this->name);
        }
    ...
    public function getBaseUrl()
    {
        ...
        $this->_baseUrl = ($this->publishResources)
            ...
            : rtrim(Yii::getAlias('@zikwall/encore/themes/' . $this->name), '/');
        return $this->_baseUrl;
    }
