...
namespace zikwall\encore\modules\core\components\base;
...
class Controller extends \yii\web\Controller
{
    ...
    {
        return $this->renderPartial('@zikwall/encore/modules/core/views/htmlRedirect.php', [
            'url' => Url::to($url)
        ]);
    }
    ...
    {
        return $this->renderPartial('@zikwall/encore/modules/core/views/modalClose.php', []);
    }
    ...
    public function setJsViewStatus()
    {
        ...
        $this->view->registerJs('encore.modules.ui.view.setState("' . $moduleId . '", "' . Yii::$app->controller->id . '", "' . Yii::$app->controller->action->id . '");', \yii\web\View::POS_BEGIN);
        if (Yii::$app->request->isPjax) {
            \zikwall\encore\modules\admin\widgets\AdminSidebarWidget::setViewState();
        }
    }
}
