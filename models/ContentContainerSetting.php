...
namespace zikwall\encore\modules\core\models;
...
class ContentContainerSetting extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['contentcontainer_id'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['contentcontainer_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'contentcontainer_id']);
    }
