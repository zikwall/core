...
namespace zikwall\encore\modules\core\helpers;

use Yii;
use yii\helpers\ArrayHelper;
use zikwall\encore\modules\core\components\base\Theme;

class ThemeHelper
{
    /**
     * Возвращает массив всех доступных тем.
     */
    public static function getThemes() : array
    {
        $themes = self::getThemesByPath(Yii::getAlias('@encore/themes'));
     ...
     */
    public static function getThemeConfig(Theme $theme) : array
    {
        if (is_string($theme)) {
