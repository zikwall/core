...
use yii\helpers\Url;
use zikwall\encore\modules\core\modules\developer\widgets\PanelRow;
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="devpanel-body">
            ...
            PanelRow::widget([
                'items' => [
                    ['title' => Yii::t('DeveloperModule.views_index_index', 'My first Module'), 'url' => Url::to(['/devtools/tutorial/first']), 'text' => Yii::t('DeveloperModule.views_index_index', 'Create your first HumHub module.')],
